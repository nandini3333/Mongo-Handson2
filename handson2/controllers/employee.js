...
const employeeData = async (req,res) => {
    ...
    try{
        ...
        console.log("the result of database operations => ", result)
...
module.exports = {employeeData,findEmployeeSalary,findEmployeeExperience,
    findEmpGradExperience,empSalaryUpdate,employeeDelete  }